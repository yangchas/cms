    ...
    public void initMethods() {
        ...
        for (int i = 0; i < methods.length; ++i) {
            ...
            if (Pattern.matches(gs, methodName)) {
                ...
                logger.warn(methodName + " 不是getter,setter方法！");
            }
        }
    }
    ...
    public boolean setMethodValue(String property, Object object) {
        ...
        if (m != null) {
            try {
                ...
                logger.warn("invoke setter on " + property + " error: " + ex.toString());
                return false;
            }
        }
        return false;
    ...
    public Object getMethodValue(String property) {
        ...
        if (m != null) {
            try {
                ...
                logger.warn("invoke getter on " + property + " error: " + ex.toString());
            }
        }
        return value;
    }
