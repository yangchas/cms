        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form method="post" action="${base}/admin/setting/${action}.jhtml" class="form-horizontal"
                          id="mainForm">
                        <input id="id" name="id" class="form-control" type="hidden" value="${setting.id}">
                            ...
                            <div id="tab-1" class="tab-pane active">
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label"><span class="text-danger">*</span>&nbsp;网站名称：</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="siteUrl" name="siteUrl" class="form-control" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="hotSearch" name="hotSearch" class="form-control" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="certtext" name="certtext" class="form-control" type="text"
                            ...
                            <div id="tab-2" class="tab-pane">
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="fileUploadPath" name="fileUploadPath" class="form-control"
                                                   type="text"
                                    ...
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">启用CNZZ：</label>
                                        <div class="col-sm-8">
                                            <input name="_isCnzzEnabled" value="false" type="hidden">
                                            <div class="checkbox checkbox-success">
                                                <input id="isCnzzEnabled" name="isCnzzEnabled" value="true"
                                                       type="checkbox" [#if setting.isCnzzEnabled]
                                                       checked="checked"[/#if] />
                                                <label for="isCnzzEnabled">
                                                    启用
                                                </label>
                                            </div>
                                    ...
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">CNZZ统计站点ID：</label>
                                        <div class="col-sm-8">
                                            <input id="cnzzSiteId" name="cnzzSiteId" class="form-control" type="text"
                                                   value="${setting.cnzzSiteId}">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">CNZZ统计密码：</label>
                                        <div class="col-sm-8">
                                            <input id="cnzzPassword" name="cnzzPassword" class="form-control"
                                                   type="text" value="${setting.cnzzPassword}">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                </div>
