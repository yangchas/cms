        ...
        <div class="row row-lg">
            <div class="panel panel-default">
                ...
                <div class="panel-body form-group">
                    <label class="col-sm-2 control-label">SEO名称：</label>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $table.bootstrapTable({
            url: "${base}/admin/seo/getPage.jhtml",//请求数据url
        ...
        $btnEdit.click(function () {
            ...
            window.location.href = "${base}/admin/seo/edit/" + selectId + ".jhtml";
        });
        ...
        $btnDelete.click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type: "post",
                    dataType: "json",
                    url: '${base}/admin/seo/delete/' + selectId + '.jhtml',
