...
<head>
    ...
    <link href="${base}/static/admin/css/plugins/codemirror/codemirror.css" rel="stylesheet">
    <link href="${base}/static/admin/css/plugins/codemirror/ambiance.css" rel="stylesheet">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form method="post" action="${base}/admin/adPosition/${action}.jhtml" class="form-horizontal"
                          id="mainForm">
                        <input id="id" name="id" class="form-control" type="hidden" value="${adPosition.id}">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><span class="text-danger">*</span>&nbsp;宽度：</label>
                            <div class="col-sm-8">
                                <input id="width" name="width" class="form-control" type="text"
                                       value="${adPosition.width}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><span class="text-danger">*</span>&nbsp;高度：</label>
                            <div class="col-sm-8">
                                <input id="height" name="height" class="form-control" type="text"
                                       value="${adPosition.height}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="description" name="description" class="form-control" type="text"
                                       value="${adPosition.description}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><span class="text-danger">*</span>&nbsp;模板：</label>
                            <div class="col-sm-8">
                                <textarea id="template" name="template">${adPosition.template}</textarea>
                            </div>
                        </div>
...
<script src="${base}/static/admin/js/plugins/codemirror/codemirror.js"></script>
<script src="${base}/static/admin/js/plugins/codemirror/mode/javascript/javascript.js"></script>
...
<script type="text/javascript">
    ...
    var myTextarea = document.getElementById('template');
