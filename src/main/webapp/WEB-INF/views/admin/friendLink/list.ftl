    ...
    <div class="ibox-content">
        <div class="row row-lg">
            ...
            <div id="toolbar" class="btn-group">
                <a id="btn_add" type="button" class="btn btn-white" href="${base}/admin/friendLink/add.jhtml">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $table.bootstrapTable({
            url: "${base}/admin/friendLink/getPage.jhtml",//请求数据url
        ...
        $btnEdit.click(function () {
            ...
            window.location.href = "${base}/admin/friendLink/edit/" + selectId + ".jhtml";
        });
        ...
        $btnDelete.click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type: "post",
                    dataType: "json",
                    url: '${base}/admin/friendLink/delete/' + selectId + '.jhtml',
