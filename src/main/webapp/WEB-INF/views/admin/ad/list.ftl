        ...
        <div class="row row-lg">
            <div class="panel panel-default">
                ...
                <div class="panel-body form-group">
                    <label class="col-sm-2 control-label">广告管理：</label>
            ...
            <div id="toolbar" class="btn-group">
                <a id="btn_add" type="button" class="btn btn-white" href="${base}/admin/ad/add.jhtml">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $table.bootstrapTable({
            url: "${base}/admin/ad/getPage.jhtml",//请求数据url
            queryParams: function (params) {
                return {
                    pageNumber: params.pageNumber,  //页码
                    pageSize: params.pageSize,   //页面大小
                    search_LIKE_title: $searchTitle.val(), //搜索名称
        ...
        $btnEdit.click(function () {
            ...
            window.location.href = "${base}/admin/ad/edit/" + selectId + ".jhtml";
        });
        ...
        $btnDelete.click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type: "post",
                    dataType: "json",
                    url: '${base}/admin/ad/delete/' + selectId + '.jhtml',
